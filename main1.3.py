    ...
    try:
        ...
        def tutorial(message):
            ...
            button1 = telebot.types.InlineKeyboardButton(
                "next", callback_data="tutorial1")
            markup.add(button1)
            bot.send_message(user_id, '1 of 4')
        ...
        def tutorial1(message):
            ...
            markup = telebot.types.InlineKeyboardMarkup()
            button1 = telebot.types.InlineKeyboardButton(
                "next", callback_data="tutorial2")
            markup.add(button1)
            bot.send_message(user_id, '2 of 4')
            photo = "lions_share.jpeg"
            file = open("./" + photo, "rb")
        ...
        def tutorial2(message):
            ...
            markup = telebot.types.InlineKeyboardMarkup()
            button1 = telebot.types.InlineKeyboardButton(
                "next", callback_data="tutorial3")
            markup.add(button1)
            bot.send_message(user_id, '3 of 4')
            photo = "lions_share.jpeg"
            file = open("./" + photo, "rb")
        ...
        def tutorial3(message):
            ...
            markup = telebot.types.InlineKeyboardMarkup()
            button1 = telebot.types.InlineKeyboardButton(
                "next", callback_data="tutorial4")
            markup.add(button1)
            bot.send_message(user_id, '4 of 4')
            photo = "lions_share.jpeg"
            file = open("./" + photo, "rb")
        ...
        def tutorial4(message):
            user_id = message.from_user.id
            bot.send_message(user_id, "To get started, "
                             "please tell me your name")
            ask_quser_name(message)
        ...
        def start(message):
            ...
            markup = telebot.types.InlineKeyboardMarkup()
            button1 = telebot.types.InlineKeyboardButton(
                "alone", callback_data="button21")
            button2 = telebot.types.InlineKeyboardButton(
                "connect", callback_data="button22")
            markup.add(button1, button2)
            bot.send_message(user_id, 'Are you interested in connecting '
                             'to your partner, or would you prefer to '
                             'begin on your own?', reply_markup=markup)
        ...
        def callback_handler(call):
            ...
            if call.data == "button2":
                ...
                greet_user(call.message.chat.id)
            elif call.data == "button22":
                input(call.message)
            elif call.data == "tutorial1":
                tutorial1(call)
            elif call.data == "tutorial2":
                tutorial2(call)
            elif call.data == "tutorial3":
                tutorial3(call)
            elif call.data == "tutorial4":
                tutorial4(call)
